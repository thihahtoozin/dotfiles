...
vim.o.linebreak = true -- Companion to wrap, don't split words (default: flase)
vim.o.mouse = 'a' -- Enable mouse mode (default: '')
vim.o.autoindent = true -- Copy indent from current line when starting new line (default: true)
vim.o.ignorecase = true -- (default: false)
